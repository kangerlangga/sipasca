...
<?= form_open_multipart('PoskoFaskes/editDataPosko/'.$posko['id_posko']) ?>
<div class="row">

    <div class="col-sm-6">
        <div class="form-group">
            <label for="Nama-Posko">Nama Posko atau Faskes</label>
            <input class="form-control" name="nama-Posko" id="Nama-Posko" value="<?= $posko['identitas_posko']?>">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" name="alamat" id="Alamat" value="<?= $posko['alamat_posko']?>">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" name="nama-Petugas" id="Nama-Petugas" value="<?= $posko['nama_petugas']?>">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" name="telp-Petugas" id="Telp-Petugas" type="tel" value="<?= $posko['telepon_petugas']?>">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" name="latitude" id="Latitude" readonly style="cursor: not-allowed;" value="<?= $posko['lat_posko']?>">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" name="longitude" id="Longitude" readonly style="cursor: not-allowed;" value="<?= $posko['long_posko']?>">
...
<a href="<?= base_url('PoskoFaskes') ?>" class="btn btn-success tbl-kembali">KEMBALI</a>
<?= form_close() ?>
<hr>
...
<script type="text/javascript">
    ...
    var curLocation = [<?= $posko['lat_posko']?>, <?= $posko['long_posko']?>];
